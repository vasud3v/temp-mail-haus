...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free disposable email inbox. No signup, no tracking, auto-delete in 24h." },
      { name: "author", content: "Tempbox" },
      { property: "og:title", content: "Tempbox — Temporary Email That Just Works" },
      { property: "og:description", content: "Free disposable email inbox. No signup, no tracking, auto-delete in 24h." },
